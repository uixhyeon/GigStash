<template>
  <div class="min-h-screen bg-gradient-to-br from-primary via-primary/90 to-primary/80 flex items-center justify-center">
      ...
      <div class="bg-white rounded-2xl shadow-2xl p-8 dark:bg-gray-800">
        ...
        <div class="text-center mb-8">
          <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary/10 mb-4">
            <svg class="w-8 h-8 text-primary" fill="currentColor" viewBox="0 0 24 24">
              <path d="M3 3h7v7H3V3zm2 2v3h3V5H5zm7-2h7v7h-7V3zm2 2v3h3V5h-3zM3 13h7v7H3v-7zm2 2v3h3v-3H5zm7-2h7v7h-7v-7zm2 2v3h3v-3h-3z" />
            </svg>
          </div>
          <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">GigStash</h1>
          <p class="text-gray-600 dark:text-gray-400">관리자 로그인</p>
        </div>
        ...
        <form @submit.prevent="handleLogin" class="space-y-5">
          ...
          <div class="flex items-center gap-2">
            ...
            />
            <label for="rememberEmail" class="text-sm font-medium text-gray-700 dark:text-gray-300 cursor-pointer">
              아이디 저장
            </label>
          </div>

          <!-- Error message -->
          <div v-if="error" class="p-3 bg-red-50 border border-red-200 rounded-lg text-sm text-red-600 dark:bg-red-900/20 dark:border-red-900 dark:text-red-400">
            {{ error }}
          </div>
        ...
        <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
          ...
          <div class="space-y-2 text-xs bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
