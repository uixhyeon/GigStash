...
const statusClasses = {
  ...
  'in-use': {
    chip: 'inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium transition-all bg-teal-100 text-teal-700 dark:bg-teal-500/20 dark:text-teal-400',
    dot: 'w-1.5 h-1.5 rounded-full flex-shrink-0 bg-teal-600 dark:bg-teal-400',
  },
  broken: {
  ...
  취소: {
    chip: 'inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium transition-all bg-warning/20 text-warning dark:bg-warning/30 dark:text-warning',
    dot: 'w-1.5 h-1.5 rounded-full flex-shrink-0 bg-warning dark:bg-warning',
  },
  '진행 중': {
    chip: 'inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium transition-all bg-teal-100 text-teal-700 dark:bg-teal-500/20 dark:text-teal-400',
    dot: 'w-1.5 h-1.5 rounded-full flex-shrink-0 bg-teal-600 dark:bg-teal-400',
  ...
  종료: {
    chip: 'inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium transition-all bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-400',
    dot: 'w-1.5 h-1.5 rounded-full flex-shrink-0 bg-gray-600 dark:bg-gray-400',
  },
}
