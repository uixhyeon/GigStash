  ...
  <div class="flex min-h-screen bg-gray-50 dark:bg-slate-900 transition-colors duration-200">
    ...
    >
      ...
      >
        ...
        >
          <!-- 접기 아이콘 (펼쳐진 상태) -->
          <svg v-if="!isSidebarCollapsed" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <!-- 왼쪽 라인 -->
            <line x1="5" y1="6" x2="5" y2="18"></line>
            <!-- 중앙 라인 -->
            <line x1="12" y1="6" x2="12" y2="18"></line>
            <!-- 오른쪽 화살표 -->
            <polyline points="16 12 19 12 16 9"></polyline>
            <polyline points="16 12 19 12 16 15"></polyline>
          </svg>
          <!-- 펴기 아이콘 (접힌 상태) -->
          <svg v-else class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <!-- 왼쪽 화살표 -->
            <polyline points="8 12 5 12 8 9"></polyline>
            <polyline points="8 12 5 12 8 15"></polyline>
            <!-- 중앙 라인 -->
            <line x1="12" y1="6" x2="12" y2="18"></line>
            <!-- 오른쪽 라인 -->
